...
class RSLog:
    ...
    def LogEndProcess(self):
        ...
        for gameid in self.games.keys():
            ...
            self.gameplays[gameid].game_key = thisGame
            self.gameplays[gameid].hitter_key = HitterLookup[self.gameplays[gameid].hitter_key]
            self.gameplays[gameid].pitcher_key = PitcherLookup[self.gameplays[gameid].pitcher_key]
            self.gamebases[gameid].game_key = thisGame
            self.gamelineups[gameid].game_key = thisGame
            self.gamelineups[gameid].player_key = HitterLookup[self.gamelineups[gameid].player_key]
            self.pitroster[gameid].game_key = thisGame
        '''
